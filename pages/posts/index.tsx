...
const Posts: NextPage = () => {
  const [postId, setPostId] = useState((posts.length - 1).toString(10))
            ...
            <div className={s.left_side}>
              ...
              <div className={s.all_posts} id={'posts'}>
                {posts
                  ...
                  .map((post) => {
                    return (
                      <div id='post' key={post.id} className={`${s.post} ${post.id === postId ? s.active_post : ''}`} onClick={() => setPostId(post.id)}>
              ...
              <div className={s.arrow} onClick={() => handleClick()}>
                <Image src='/images/right_chevron.svg' alt='right_chevron' width={40} height={40} />
              </div>
            </div>
