      ...
      <div>
        <>
          <p style={{ fontWeight: '600' }}>
            Доступно ли преподаватель излагает материал?
          </p>
          ...
          <p>
            ...
            женой/мужем, ребенком, родителями), что за каждое употребление на
            семинаре или лекции слов типа &laquo;преюдиция&raquo;,
            &laquo;экзекватура&raquo; или &laquo;превентивный&raquo; вы будете
            выплачивать 1000 рублей (вариант: вне очереди гулять с собакой, мыть
            после себя посуду, не разбрасывать куда попало носки, совершать
            дополнительный визит к теще).
          </p>
          ...
          <>
            ...
            <p>
              ...
              примеру, как объяснить принципиально разный подход законодателя к
              инстанционным границам реализации такого распорядительного
              полномочия, как отказ от иска в гражданском и арбитражном
              процессе? Не просто теоретически обосновать, а именно так, чтобы
              оказать &laquo;положительное влияние на формирование уважительного
              отношения к праву и закону&raquo;? Долго сам думал над
              этим&hellip; Предлагаю вот как излагать логику этого
              ...
              иска, после вступления решения суда в законную силу злоупотребляли
              правом на судебную защиту, отказываясь от иска. В гражданском же
              процессе законная сила судебного акта не имеет столь важного
              значения&nbsp;&ndash; обычно это касается частного спора, который
              не способен оказать существенного влияния на оборот. Вот поэтому
              здесь отказываться от иска можно на любой стадии&raquo;. Вроде бы
              чистой воды демагогия, но зато как влияет на формирование
              уважительного отношения к праву и закону!
            </p>
          </>
          <>
            <p style={{ fontWeight: '600' }}>
              Проявлял ли преподаватель уважение к мнению студентов?
            </p>

            <p>
              На самом деле, это вопрос с подвохом &ndash; в нем уже содержится
              утверждение, что студент может иметь свое мнение. Составители
              опросника &ndash; люди с большим чувством юмора. Мы-то с вами
              понимаем, что даже после годового курса общения большинство
              студентов остаются, мягко говоря, инертны, и добиться от них
              какого-то собственного мнения по правовому вопросу архисложно.
            </p>
            <p>
              Что же делать? Правильно &ndash; симуляция! Опытный преподаватель
              легко интерпретирует фразу типа &laquo;Э-э-э&hellip; Ну, типа,
              скорее всего, тут суд поступил неправильно&hellip;
              Вот&hellip;&raquo;, изложив ее смысл перед всей группой примерно
              так: &laquo;Как верно указал Василий Алибабаевич, действия суда в
              этой ситуации были неправомерны, поскольку императивный метод
              правового регулирования не допускает реализацию таких
              процессуальных полномочий, которые прямо законом не
              предусмотрены&raquo;.
            </p>
          </>
          <>
            ...
            <p>
              ...
              Университета. Но на всякий случай все же рекомендую действовать на
              опережение и хотя бы пару раз за семинар задумчиво произносить
              фразы типа &laquo;Кстати, какая все-таки прекрасная идея убрать
              стоянку машин перед зданием главного корпуса!&raquo;, &laquo;Не
              перестаю поражаться технологичности решения: как чудесно придумали
              &ndash; идешь по переходу, а тут тебе музей!&raquo;, &laquo;О, как
              бодрит запах, исходящий от кофе-машины, как стимулирует мозговую
              деятельность! Как же все-таки хорошо, что теперь на каждом этаже
              есть эти чудесные аппараты!&raquo;
            </p>
          </>
          <>
            <p style={{ fontWeight: '600' }}>
              Допускал ли преподаватель некорректные высказывания в адрес других
              коллег?
            </p>
            ...
            <p>
              ...
              хочется узнать, кто же так блестяще поработал над студентами. Что
              ж, теперь остается лишь глубокомысленно закатывать глаза и
              произносить что-то типа &laquo;Жаль, конечно, что вексельное право
              не преподается как отдельная дисциплина&hellip; Я вот в свое время
              наизусть запомнил довольно простое правило - протест в неплатеже
              переводного векселя сроком на определенный день или во столько-то
              времени от составления или предъявления должен быть совершен в
              один из двух рабочих дней, которые следуют за днем, в который
              переводный вексель подлежит оплате. Да, жаль&hellip;&raquo;
            </p>
          </>
          <>
            <p style={{ fontWeight: '600' }}>
            ...
            <p>
              Да-да, теперь это карается! Никаких двусмысленных шуток о качестве
              подготовки к семинару, никаких обвинений в разгильдяйстве, никаких
              пророческих слов о будущей карьере конкретного студента. Только
              предельно корректные высказывания типа &laquo;Возможно, у Вас была
              слишком тяжелая учебная неделя, что привело к невозможности
              надлежащей подготовки к данному семинару&raquo;, &laquo;Не
              сомневаюсь, что столь основательные знания по предмету будущий
              работодатель расценит как дополнительное конкурентное
              преимущество&raquo;, &laquo;С такой тягой к знаниям Вы в скором
              времени вполне могли бы возглавить профильный комитет
              Государственной Думы&raquo;.
            </p>
          </>
          <>
            <p style={{ fontWeight: '600' }}>
            ...
            <p>
              ...
              литературу&raquo;. Какая еще дополнительная литература?! Уважаемые
              составители опросника, не надо так жестоко шутить! Преподаватель
              уже рад, если студент перед экзаменом компендиум открыл. А тут
              &ndash; до экзамена! самостоятельно! изучал! дополнительную
              литературу! А-а-а&hellip; Держите меня двое&hellip; Я под
              столом&hellip;
            </p>
          </>
          <>
            ...
            <p>
              ...
              действовать на опережение &ndash; приучайте студентов с первого же
              семинара называть доску и кусок мела специальными терминами:
              &laquo;Итак, кто готов, используя визуальное средство и осадочную
              горную породу белого цвета органического происхождения, рассчитать
              подлежащую уплате государственную пошлину?&raquo; В итоге через
              пару месяцев общения с Вами они будут искренне убеждены, что Вы
              просто безостановочно использовали аудиовизуальные и
              мультимедийные средства и технологии.
            </p>
          </>
        </>
      </div>
