  ...
  return (
    <div className={s.container}>
      ...
      <p>
        <strong>
          <em>
            Преподавателю-процессуалисту, который познакомился с кандидатом физико-математических наук и решил блеснуть своими знаниями из геометрии, сказав,
            что площадь круга 2&pi;r
          </em>
        </strong>
      </p>
      <div className={s.small_space_between_p}>
      ...
      <p>
        <strong>
          <em>Доценту, у которого во время заседания учебно-методической группы по арбитражному процессу пробежала мысль для будущей статьи</em>
        </strong>
      </p>
      <div className={s.small_space_between_p}>
        <p>
      ...
      <p>
        <strong>
          <em>Доценту, которого внезапно посреди ночи посетила мысль</em>
        </strong>
      </p>
      <div className={s.small_space_between_p}>
        <p>
          ...
          ,<br />В Москве заснул Нескучный сад,
          <br />
      ...
      <p>
        ...
        Речь идет о Свердловской областной универсальной научной <em>библиотеке</em> им. В.Г.{' '}
        <em>Белинского (подозреваю, что не все знают о ее существовании).</em>
      </p>
      <p>
        <a href='#_ftnref2'>
          <span>[2]</span>
      ...
      <p>
        <strong>
          <em>Коллегам, которые норовят поздравить других процессуалистов с неизбежными юбилеями, или Искусство быть посторонним&nbsp; </em>
        </strong>
      </p>
      <div className={s.small_space_between_p}>
      ...
      <p>
        <strong>
          <em>Свое и чужое, или Когда решил поделиться гениальными мыслями из собственных статей с коллегами по кафедре</em>
        </strong>
      </p>
      <div className={s.small_space_between_p}>
        <p>
