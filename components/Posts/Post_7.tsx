    ...
    <div className={s.container}>
      ...
      <ol>
        <li>
          ...
          за которое он по гроб жизни будет обязан.
        </li>
        <li>
        ...
        <li>
          ...
          прямо при научном руководителе, ибо у тебя от него секретов нет.
        </li>
        <li>
          ...
          &laquo;Спам&raquo; - с чего бы это, а?
        </li>
        <li>
        ...
        <li>
          ...
          научный руководитель все равно уже их прочитал.
        </li>
        <li>
        ...
        <li>
          ...
          руководителем положения, которые могли бы быть включены в новизну.
        </li>
        <li>
          ...
          есть оправдание (ссылочка-то выше ведь имеется!)
        </li>
        <AccentedBlock>
          <li>
        ...
        <li>
          ...
          предмету с лихвой компенсирует твоя широчайшая эрудиция.
        </li>
        <li>
          ...
          прекрасно понимают смысл этих пассажей
        </li>
        <li>
          ...
          снисходительно, половину из них вообще спокойно игнорируй.
        </li>
        <AccentedBlock>
          <li>
        ...
        <li>
          ...
          реального времени. Посмотришь на их реакцию.
        </li>
        <li>
          ...
          бодрым тостом &laquo;За ирригацию Узбекистана!&raquo;
        </li>
        <li>
